...
<?php
  ...
  mysql_select_db("sas_db");
    $q="SELECT * FROM `maintenance_bill_paid_record`";
  $resource = mysql_query($q);
  $count = mysql_num_rows($resource);
  //---------------------------------
   $q2="SELECT * FROM `funds`";
...
<head>
    ...
    <title>Manage Society Account</title>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h2 class="title">All Manintenance Bill Paid Record</h2>
                                <p class="category"></p>
                            </div>
              ...
              <td><?php echo $row[7]; ?></td>
                    ...
                    <div class="col-md-12">
                        <div class="card card-plain">
                            <div class="header">
                                <h2 class="title">Society Fund</h2>
                                <p class="category">-</p>
                            </div>
                            <div class="content table-responsive table-full-width">
                                <div class="tablediv">
