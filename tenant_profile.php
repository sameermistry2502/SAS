...
<div class="wrapper">
    ...
    <!--   you can change the color of the sidebar using: data-color="blue | azure | green | orange | red | purple" -->
    	...
    	<div class="sidebar-wrapper">
            ...
            <ul class="nav">
                ...
                <li>
                    <a href="http://localhost:90/chat/" target="_blank">
 ...
 <form>
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Enter Tenant Profile<span style="color: red;">*</span></label>
                                                <input type="file" ng-model="tvProfile" name="tvProfile" class="form-control" />
                                            </div>
                                        </div>
                                    </div>
                                   ...
                                   <div class="row">
                                      ...
                                      <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="password" ng-model="txtCpassword" class="form-control" size="22" placeholder="Enter Confirm Password" required/>
                                            </div>
                                        </div>
                                    </div>
                                   ...
                                   <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                     <button type="submit" name="MemberRegister" class="btn btn-info btn-fill pull-right"  ng-click="insertData()">UPDATE NOW</button>
