                            ...
                            <div class="content">
                                <form>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Fund For<span style="color: red;">*</span></label>
                                                <input type="text" ng-model="fFor" class="form-control" size="22" placeholder="Enter Name"  required/>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Fund From<span style="color: red;">*</span></label>
                                                <input type="text" ng-model="fFrom" class="form-control" size="22" placeholder="Enter From" required/>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" ng-model="fSocr" class="form-control" size="22" placeholder="Enter Society"  required/>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Amount<span style="color: red;">*</span></label>
                                                <input type="text" ng-model="fAmount" class="form-control" size="22" placeholder="Enter Amount" required/>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Fund Description<span style="color: red;">*</span></label>
                                                <textarea name="fDesc" ng-model="fDesc" class="form-control" id="" cols="30" rows="8" placeholder="Enter Descriptiopn"></textarea>
                                            </div>
                                        </div>
