            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">ADD-SOCIETY-FUNDS</h4>
                            </div>
                            <div class="content">
                                <form>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" ng-model="bpName" class="form-control" size="22" placeholder="Enter Name"  required/>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Email<span style="color: red;">*</span></label>
                                                <input type="email" ng-model="bpEmail" class="form-control" size="22" placeholder="Enter Email" required/>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Contact Number<span style="color: red;">*</span></label>
                                                <input type="text" ng-model="bpCon" class="form-control" size="22" placeholder="Enter Contact Number" required/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Maintenance Paid Date<span style="color: red;">*</span></label>
                                                <input type="date" ng-model="bpdate" class="form-control" size="22" placeholder="Enter Date"  required/>
                                            </div>
                                        </div>
                                       <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Society<span style="color: red;">*</span></label>
                                                <input type="text" ng-model="bpSoc" class="form-control" size="22" placeholder="Enter Society" required/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Month<span style="color: red;">*</span></label>
                                                        <select id='gMonth1' ng-model="bpMonth" class="form-control">
    ...
    <option value='12'>December</option>
                                       ...
                                       <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" ng-model="bpAmount" class="form-control" size="22" placeholder="Enter Amount" required/>
                                            </div>
                                        </div>
...
<script>
 ...
 $http.post("bill_record_insert.php", {
    'bpName':$scope.bpName,
     'bpEmail':$scope.bpEmail,
    'bpCon':$scope.bpCon,
    'bpdate':$scope.bpdate,
    'bpSoc':$scope.bpSoc,
    'bpMonth':$scope.bpMonth,
    'bpAmount':$scope.bpAmount
