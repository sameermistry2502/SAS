...
<head>
	...
	<title>View All Sales Inquiery Data</title>
                     ...
                     ?>  
                        ...
                        <li class="dropdown">
                              ...
                              <ul class="dropdown-menu">
                                ...
                                <li class="active"><a href="sec_view_sales_Inquiery.php">View Sales Inquiery</a></li>
                              </ul>
                        </li>
                        <li>
                            <a href="slogout.php">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <div class="card card-plain">
                            <div class="header">
                                <h4 class="title">SALES INQUIERY DETAILS</h4>
